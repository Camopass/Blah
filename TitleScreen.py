...
class TitleScreen(Scene):
    def setup(self):
        ...
        self.font = pygame.font.Font("assets/fonts/vcr.ttf", 65)
        ...
        def on_click(window):
            self.next_scene = Game(self.window, self.clock)
    ...
    def render(self):
        ...
        self.window.screen.blit(self.font.render("BLAH", True, (150, 255, 175)), (800 - (self.font.size("BLAH")[0] / 2), 200 - (self.font.size("BLAH")[1] / 2)))
